...
- Обеспечить сетевое взаимодействие хостов (**PC1**, **PC2**, **PC3**, **PC4**) установив **маршрутизацию между VLAN** (**inter-VLAN routing**) по технологии **виртуальных коммутируемых интерфейсов** (**SVI &ndash; Switch Virtual Interface**).
- Обеспечить сетевое взаимодействие хостов **PC1** &ndash; **PC4** с хостом **PC5** установив **статический маршрут по умолчанию** на **восходящем канале** (**uplink**).
