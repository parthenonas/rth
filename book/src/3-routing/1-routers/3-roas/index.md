...
- Обеспечить сетевое взаимодействие хостов (**PC1**, **PC2**, **PC3**, **PC4**) разрешив **маршрутизацию между VLAN** (**inter-VLAN routing**) по технологии **роутер на палочке** (**Router-on-a-stick**).
...
| ├─ Подсеть Юго-запад | 172.16.16.0/26 | R1 (172.16.16.62) | PC1; PC2; R1 |
| ├─ Подсеть Юг-центр | 172.16.16.64/26 | R1 (172.16.16.100) | PC3; R1 |
| └─ Подсеть Юго-восток | 172.16.16.128/26 | R1 (172.16.16.129) | PC4; R1 |
